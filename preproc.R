...
stations <- read.csv(file = 'data/csv/estaciones_utf.csv', header = TRUE, sep = ';', dec = '.', encoding = 'UTF-8')
colnames(stations)[1] ='NMT'
colnames(stations)[2] ='Names'

data_2022 <- read.csv(file = 'data/csv/2022.csv', header = TRUE, sep = ';', dec = ',',stringsAsFactors=F)
data_2021 <- read.csv(file = 'data/csv/2021.csv', header = TRUE, sep = ';', dec = ',')
data_2020 <- read.csv(file = 'data/csv/2020.csv', header = TRUE, sep = ';', dec = ',')
...
save(df, file = "data/rdata/data_df.RData")
save(stations, file = 'data/rdata/stations.RData')
